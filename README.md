...
* **Rockafellar–Uryasev Variational Formulation:** Computes non-parametric $\text{VaR}_\alpha$ via introselect order statistics ($L_{(\lceil M\alpha \rceil)}$) and solves $\text{ES}_\alpha$ using convex optimization:
